async function t(a,e){a.innerHTML=`
    ...
    <div class="settings-group">
      ${[{icon:"🌐",label:"wyltekindustries.com",desc:"Main site · research · members",href:"https://wyltekindustries.com"},{icon:"🐙",label:"GitHub",desc:"toastmanAu — open source projects",href:"https://github.com/toastmanAu"},{icon:"📢",label:"Nervos Unofficial TG",desc:"Community group",href:"https://t.me/NervosUnofficial"},{icon:"🔬",label:"Nervos Network",desc:"CKB blockchain ecosystem",href:"https://nervos.org"}].map(s=>`
        <div class="settings-row" onclick="window.Telegram?.WebApp?.openLink('${s.href}')">
          <div class="settings-icon" style="background:rgba(0,212,255,0.08)">${s.icon}</div>
